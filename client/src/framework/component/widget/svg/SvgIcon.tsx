...
export interface IProgressIndicatorProps extends rx.CommonStyledProps<rx.Types.ImageStyleRuleSet> {
    progress: number;
    fillColor: string;
    size: number;
}

class ProgressIndicator extends rx.Component<IProgressIndicatorProps, {}> {
    render() {
