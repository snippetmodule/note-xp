    ...
    render() {
        return (
            <ReactNative.View>
                ...
                <MenuItem img={require('../../../asserts/home/menu/ic_drawer_follow.png')} tex="Follow" routerName="follow" {...this.props} />
                <MenuItem img={require('../../../asserts/home/menu/ic_fans.png')} tex="粉丝" routerName="follow" {...this.props} />
                <MenuItem img={require('../../../asserts/home/menu/ic_group.png')} tex="圈子" routerName="follow" {...this.props} />
                <MenuItem img={require('../../../asserts/home/menu/ic_scan.png')} tex="Scan" routerName="follow" {...this.props} />
                <MenuItem img={require('../../../asserts/home/menu/ic_personal.png')} tex="个人中心" routerName="follow" {...this.props} />
                <MenuItem img={require('../../../asserts/home/menu/ic_setting.png')} tex="设置" routerName="follow" {...this.props} />
            </ReactNative.View>
        );
    }
}